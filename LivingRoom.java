...
public class LivingRoom implements Screen {
    ...
    /**
     * The constructor for the living room screen
     * @param g passes the main class
     */

    public LivingRoom(SandmanMain g) {
        Gdx.app.log(TAG, "LivingRoom g = " + g);
        game = g;
        active = false;
        ...
        bg = game.resources.assetManager.get("Objects/LRbg.jpg", Texture.class);
