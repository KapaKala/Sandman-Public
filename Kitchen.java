...
public class Kitchen implements Screen {
    ...
    /**
     * The constructor for the kitchen screen
     * @param g passes the main class
     */

    public Kitchen(SandmanMain g) {
        Gdx.app.log(TAG, "Kitchen g = " + g);
        game = g;
        active = false;
        ...
        bg = game.resources.assetManager.get("Objects/KTbg.jpg", Texture.class);
