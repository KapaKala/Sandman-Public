...
/**
 * The screen that is called when you win the game in the default game mode
...
public class WinScreen implements Screen {
    ...
    /**
     * Constructor for the win screen
     * @param g passes the game class
     */

    public WinScreen(SandmanMain g) {
        Gdx.app.log(TAG, "WinScreen g = " + g);
        game = g;

        batch = game.getBatch();

        bg = game.resources.assetManager.get("loppumenuvoitto3.jpg", Texture.class);
        ...
        button.setPosition(SandmanMain.REAL_WIDTH / 2 - button.getWidth() / 2, SandmanMain.REAL_HEIGHT / 4.5f - button.getHeight() / 2);
        ...
        ngButton.setPosition(SandmanMain.REAL_WIDTH / 2 - ngButton.getWidth() / 2, SandmanMain.REAL_HEIGHT / 3f - ngButton.getHeight() / 2);
        ...
        scoreLabel = new Label("Your final score:" + game.getScore(), skin);
